...
const Filter = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-10">
      <div className="w-81.75 h-60.25 z-15 bg-white  rounded-main  ">
        ...
        <div className="mt-7 px-4">
          ...
          <button className="w-full bg-btn-primary mt-8 text-white py-2 rounded-main font-bold hover:bg-[#939bf4] cursor pointer ">
            Search
          </button>
        </div>
      </div>
