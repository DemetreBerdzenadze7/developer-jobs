...
const JobsPageSection = ({ id }: IId) => {
  ...
  return (
    <div className="max-w-182.5 -mt-12">
      <div className="flex flex-col gap-5 items-center bg-white py-8 px-10 rounded-main relative md:flex-row md:items-center md:justify-between md:w-full md:p-0">
        <div
